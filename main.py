...
if __name__ == '__main__':
    ...
    parser.add_argument('-dir_path',"-i",type=lambda x: os.path.isdir(x) and x or parser.error("Directory does not exist."), default=r"H:\新建文件夹\319",
    ...
    if dir_path is None:
        parser.error("dir_path is required.")
    # 获取 r_path
    r_path = args.r_path
